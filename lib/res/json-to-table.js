...
function ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText)
{
    ...
    var tbl = '<table data-table-to-csv="report-'+new Date().getTime()+'.csv" border="1" cellpadding="1" cellspacing="1"' + idMarkup + classMarkup + '>{0}{1}</table>';
            ...
            if(headers)
            {
                ...
                for (i = 0; i < parsedJson.length; i++)
                {
                    for (j = 0; j < headers.length; j++)
                    {
                        ...
                        {
                            if(value){
                              //TODO: if the cloumn is array, will result null??
